  ...
  en: {
    ...
    hero: {
      ...
      player: {
        ...
        albumAlt: "Album artwork for N'Djamena by Ibrahim Khalil",
        playlists: [
    ...
    social: {
      label: "Trusted by",
      heading: "Trusted by artists, fans, music creators and the streaming community",
    ...
    artists: {
      eyebrow: "To make a living from one's music",
      title: "Your music deserves to be paid what it's worth.",
      body: "According to our studies, the CRBT (Chadian Cultural Heritage Fund) only paid 4% royalties to some artists for their work. Physical sales have disappeared. YouTube does not pay royalties for content produced in Chad. Global streaming platforms are ill-suited to the realities of Chadian artists and content creators. ASRAPA is changing the game.",
      highlight1Strong: "65% of the revenue goes to the artists",
      highlight1Rest: ", distributed according to your actual listens. 35% funds the platform.",
      highlight2Strong: "Transparent quarterly report",
      highlight2Rest: ", payment within 30 days, to bank account or mobile money.",
      labelled: "Labelled Artists",
      labelledBody: "Make your production investments profitable.",
      independent: "Independent artists",
      independentBody: "Express your talent without restraint.",
      startCatalog: "Start my catalog",
      compensation: "How does compensation work?",
      ...
      incomeFoot:
        "Distribution based on actual listening · quarterly report · payment within 30 days · bank account or mobile money.",
    },
    network: {
    ...
    cta: {
      ...
      body: "Join the listeners, artists and agents building the next chapter of African music on Asrapa.",
      getStarted: "Get Started",
